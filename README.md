...
Spent three years designing for clients and led user research, designed interfaces, and partnered with engineering teams to ship features with measurable impact: 40% efficiency gains at Kawasaki Japan, contributed to $13M Series A at Canary Speech. Now pursuing my MS in Computer Science at Northeastern to understand the full stack—from algorithms to architecture to production code.
...
**UCLA Health** — Led user research and redesigned patient booking flow. Removed friction points, significantly increased online appointment completion.

**Canary Speech** — Designed MVP for AI voice analysis platform supporting mental health diagnostics. Research with clinicians/patients contributed to $13M Series A.
